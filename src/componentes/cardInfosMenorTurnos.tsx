...
function CardInfosMenorTurnos({ }: {}) {
  ...
  const { data: dataTurnoAbertos } = useFaturamentoClienteId(
  ...
  const { data: dataTurnoConcluidos } = useFaturamentoClienteId(
    getMonthRangeISO().inicioISO,
    getMonthRangeISO().fimISO,
    String(empresaClienteId),
    "Concluido",
    ...
    >
      ...
      >
        ...
        >
          ...
          <strong style={{ fontSize: 14 }}>
            {Number(dataTurnoAbertos?.qntVouchers || 0) +
              Number(dataTurnoConcluidos?.qntVouchers || 0)}
          </strong>
        </p>
      </div>
      <div
      ...
      >
        ...
        >
          ...
          >
            {dataTurnoAbertos?.qntVouchers || 0}
          </h1>
          <h1
            style={{
              color: Cor.texto1,
          ...
          >
            {dataTurnoConcluidos?.qntVouchers || 0}
          </h1>
        </div>
        <div
          style={{
